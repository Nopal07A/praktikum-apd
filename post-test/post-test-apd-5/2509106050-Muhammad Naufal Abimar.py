...
while bool:
    ...
    if pilih == "1":
        ...
        pengguna_baru.append(usnbaru)
        pengguna_baru.append(pwbaru)
        print(f"\nusser dengan username {usnbaru} telah terdaftar")
    
    elif pilih == "2":
        input("\nmasukkan ussername anda : ")
        input("\nmasukkan password anda : ")
        if usnbaru in pengguna_baru and pwbaru in pengguna_baru:
            print("\nANDA BERHASIL LOGIN ")
            input("\ntekan enter unutk lanjutkan program")
            menu_user()
        else:
